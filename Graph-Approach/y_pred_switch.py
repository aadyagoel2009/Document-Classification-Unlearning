...
def main():
    ...
    centroids_before = compute_centroids(class_importance, test_dataset, y_pred, top_words)
    ...
    density_before = cluster_density(pca_data_before, y_pred, class_to_zero)
    ...
    centroids_after = compute_centroids(class_importance, test_dataset, y_pred, top_words)
    ...
    density_after = cluster_density(pca_data_after, y_pred, class_to_zero)
    ...
    unlearned_docs_raw = [doc for doc, label in zip(test_dataset, y_pred) if label == class_to_zero]
    unlearned_vectors = []
    ...
    unlearned_doc_indices = [i for i, label in enumerate(y_pred) if label == class_to_zero]
